...
class TestTokenMetrics:
    ...
    def test_calculate_reduction_potential(self):
        ...
        verbose_text = "I would very much appreciate it if you could very kindly help me"
    ...
    def test_calculate_verbosity(self):
        ...
        # Verbose text
        verbose = "I would really very much appreciate it if you could basically help me"
...
class TestSemanticMetrics:
    ...
    def test_key_concepts_extraction(self):
        ...
        assert any(concept in str(analysis.key_concepts).lower() 
    ...
    def test_semantic_density_calculation(self):
        ...
        dense_text = "Advanced neural networks facilitate sophisticated pattern recognition"
