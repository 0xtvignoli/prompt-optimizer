...
class TokenReductionStrategy(OptimizationStrategy):
    ...
    def estimate_reduction(self, prompt: str) -> float:
        ...
        abbreviation_reduction = (abbreviable_count / total_words) * 0.25  # ~25% for abbreviazione
        contraction_reduction = (contractable_count / total_words) * 0.15   # ~15% for contrazione
    ...
    def _load_removable_words(self) -> set:
        ...
        return {
            ...
            'di', 'from', 'in', 'su', 'for', 'with', 'tra', 'fra',
