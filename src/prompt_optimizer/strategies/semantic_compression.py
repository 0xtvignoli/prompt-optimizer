...
class SemanticCompressionStrategy(OptimizationStrategy):
    ...
    def _condense_equivalent_phrases(self, text: str) -> str:
        ...
        for sentence in sentences:
            ...
            if sentence and not self._is_duplicate_meaning(sentence, condensed_sentences):
    ...
    def _calculate_verbosity_score(self, text: str) -> float:
        ...
        verbose_patterns = [
            r'in order to', r'for the purpose of', r'due to the fact that',
            r'al fine di', r'allo scopo di', r'a causa del fatto che'
        ]
    ...
    def _is_contextually_important(self, words: List[str], index: int) -> bool:
        ...
        important_patterns = [
            r'very important', r'really need', r'actually means',
            r'molto importante', r'davvero necessario', r'effettivamente significa'
        ]
    ...
    def _load_filler_words(self) -> Set[str]:
        ...
        return {
            ...
            'sostanzialmente', 'praticamente', 'effettivamente', 'ovviamente',
            'chiaramente', 'sicuramente', 'certamente', 'probabilmente',
            'possibilmente', 'eventualmente', 'naturalmente',
            
            # Inglese
            'very', 'quite', 'rather', 'really', 'actually', 'basically',
            'essentially', 'obviously', 'clearly', 'certainly', 'definitely',
            'probably', 'possibly', 'eventually', 'naturally', 'literally',
            'absolutely', 'completely', 'totally', 'extremely', 'incredibly',
            
            # Espressioni temporali ridondanti
            'right now', 'at this moment', 'currently', 'presently',
            'in questo momento', 'attualmente', 'al momento'
        }
