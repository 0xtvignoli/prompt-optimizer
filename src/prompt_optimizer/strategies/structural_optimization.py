...
class StructuralOptimizationStrategy(OptimizationStrategy):
    ...
    def _reorganize_sections(self, sections: Dict[str, List[str]]) -> Dict[str, List[str]]:
        ...
        optimal_order = ['context', 'instructions', 'constraints', 'examples', 'output_format', 'other']
        reorganized = {}
    ...
    def _optimize_section_formatting(self, sections: Dict[str, List[str]]) -> Dict[str, str]:
        ...
        for section_name, content_list in sections.items():
            ...
            if section_name == 'context':
                ...
                formatted_sections[section_name] = self._format_instructions_section(content_list)
            elif section_name == 'constraints':
                formatted_sections[section_name] = self._format_constraints_section(content_list)
            elif section_name == 'examples':
                formatted_sections[section_name] = self._format_examples_section(content_list)
            elif section_name == 'output_format':
                formatted_sections[section_name] = self._format_output_section(content_list)
            else:
                formatted_sections[section_name] = self._format_other_section(content_list)
    ...
    def _classify_paragraph(self, paragraph: str) -> str:
        ...
        constraint_keywords = ['do not', 'avoid', 'must not', 'never', 'only',
                              'limit', 'restrict', 'constraint', 'requirement',
                              'non', 'evita', 'non devi', 'mai', 'solo',
    ...
    def _calculate_formatting_score(self, prompt: str) -> float:
        ...
        formatting_indicators = [consistent_spacing, proper_punctuation, no_formatting_issues]
    ...
    def _load_section_patterns(self) -> Dict[str, List[str]]:
        ...
        return {
            'context': [
                ...
                r'background:', r'context:', r'situation:',
                r'dato\\s+che', r'assumendo\\s+che', r'nel\\s+contesto',
                r'background:', r'contesto:', r'situazione:'
            ],
            'instructions': [
            ...
            'constraints': [
                ...
                r'non\\s+devi', r'vincoli?:', r'requisiti?:'
            ],
            'examples': [
            ...
            'output_format': [
                ...
                r'formato\\s+output', r'formato\\s+risposta', r'formato:'
            ]
        }
